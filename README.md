...
**NB: Working on Packer for Droplet Image that uses Wireguard instead of OpenVPN. Will be based on Ubuntu Jammy (22.04) or Debian 11. I'm creating the image on a $4 Droplet. I will be testing ipv6. Hoping I can knock this out quickly but we'll see.**
